...
public class Main {
   ...
   public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        MaxFeeTxHandler max =  new MaxFeeTxHandler(utxoPool);
        System.out.println("txHandler.isValidTx(tx2) returns: " + txHandler.isValidTx(tx2));
        System.out.println("max.isValidTx(tx2) returns: " + max.isValidTx(tx2));
        ...
        System.out.println("max.handleTxs(new Transaction[]{tx2}) returns: " + max.handleTxs(new Transaction[]{tx2}).length + " transaction(s)");
