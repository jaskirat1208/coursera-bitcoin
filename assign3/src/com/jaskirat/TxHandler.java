...
public class TxHandler {
    ...
    public boolean isValidTx(Transaction tx) {
        ...
        for (int i = 0; i < tx.numInputs(); i++) {
            ...
            if (!utxoPool.contains(utxo)){
                System.out.println(utxoPool.getAllUTXO().get(0).getTxHash());
                System.out.println("POOL DOES NOT CONTAIN UTXO with id:"+ in.prevTxHash +" and outputIndex: "+ in.outputIndex);
                return false;
    ...
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
        ...
        Transaction.Output out = utxoPool.getTxOutput(utxoPool.getAllUTXO().get(0));
        System.out.println(out.address +"\nValue:"+ out.value);
//        System.out.println(validTxs.size());
